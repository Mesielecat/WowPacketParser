...
namespace WowPacketParser.SQL.Builders
{
    ...
    public static class Locales
    {
        ...
        public static string PlayerChoiceLocale()
        {
            ...
            return "SET NAMES 'utf8';" + Environment.NewLine + SQLUtil.Compare(Storage.PlayerChoiceLocales, playerChoiceDb, StoreNameType.PlayerChoice) + Environment.NewLine + "SET NAMES 'latin1';";
        }
        ...
        public static string PlayerChoiceResponseLocale()
        {
            ...
            return "SET NAMES 'utf8';" + Environment.NewLine + SQLUtil.Compare(Storage.PlayerChoiceResponseLocales, playerChoiceResponseDb, StoreNameType.PlayerChoice) + Environment.NewLine + "SET NAMES 'latin1';";
        }
    }
}

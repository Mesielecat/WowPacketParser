...
namespace WowPacketParser.SQL.Builders
{
    ...
    public static class WDBTemplates
    {
        ...
        public static string PlayerChoiceResponseReward()
        {
            ...
            return SQLUtil.Compare(Storage.PlayerChoiceResponseRewards, templatesDb, StoreNameType.PlayerChoice);
        }
        ...
        public static string PlayerChoiceResponseRewardCurrency()
        {
            ...
            return SQLUtil.Compare(Storage.PlayerChoiceResponseRewardCurrencies, templatesDb, StoreNameType.PlayerChoice);
        }
        ...
        public static string PlayerChoiceResponseRewardFaction()
        {
            ...
            return SQLUtil.Compare(Storage.PlayerChoiceResponseRewardFactions, templatesDb, StoreNameType.PlayerChoice);
        }
        ...
        public static string PlayerChoiceResponseRewardItem()
        {
            ...
            return SQLUtil.Compare(Storage.PlayerChoiceResponseRewardItems, templatesDb, StoreNameType.PlayerChoice);
        }
